...
import jdbcModule5.selectQueries.*;
import jdbcModule5.utils.Prefs;

import java.util.List;

import static jdbcModule5.service.DataBasePrepareStatementQueryService.*;

public class Module5Runner {
    public static void main(String[] args) {

//        List<MaxProjectCountClient> maxProjectCountClients =
//                maxProjectCountClientPrepareSt(Prefs.FIND_MAX_PROJECTS_CLIENT_SQL_DB_FILENAME);
//            System.out.println("MaxProjectCountClient = " + maxProjectCountClients);

//        List<LongestProject> longestProjects =
//                longestProjectPrepareSt(Prefs.FIND_LONGEST_PROJECT_DB_FILENAME);
//        System.out.println("longestProjects = " + longestProjects);
//
//        List<MaxSalaryWorkers> maxSalaryWorkers =
//                maxSalaryWorkerPrepareSt(Prefs.FIND_MAX_SALARY_WORKER_DB_FILENAME);
//
//        System.out.println("maxSalaryWorkers = " + maxSalaryWorkers);
//
//        List<YoungestEldestWorker> youngestEldestWorkers =
//                youngestEldestWorkersPrepareSt(Prefs.YOUNGEST_ELDEST_WORKER_DB_FILENAME);
//
...
//
        List<PrintProjectPrices> printProjectPrices =
                printProjectsPricePrepareSt(Prefs.PRINT_PROJECT_PRICES_DB_FILENAME);
